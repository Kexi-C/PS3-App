...
''',
    ...
    (
        '''            "Upload one or more Rail Corrugation CSV files. "
            "Other subsystem inputs will be enabled when their programs are connected."
''',
        '''            "Upload one or more CSV files for the selected subsystem. "
            "Rail Corrugation and SHM are currently connected."
''',
    ),
    (
        '''    else:
